...
public class InterlevelScene extends PixelScene {
    ...
    public void create() {
        ...
        switch (mode) {
            ...
            case DESCEND:
                if (Dungeon.hero == null) {
                    if (SPDSettings.getDio() <= 0) neoLevel = true;
                    else diocheck = true;
                    loadingDepth = 1;
                    fadeTime = SLOW_FADE;
                } else {
                    ...
                    if (Statistics.deepestFloor >= loadingDepth) {
                        fadeTime = FAST_FADE;
                            ...
                            || loadingDepth == 16 || loadingDepth == 21 || loadingDepth == 26 || loadingDepth == 30) {
                        fadeTime = SLOW_FADE;
                    }
                }
                break;
        ...
        switch (lastRegion) {
            ...
            case 6:
            default:
                loadingAsset = Assets.Splashes.LABS;
                switch (Random.Int(3)) {
                    case 0:
                        loadingCenter = 105;
                        break;
        ...
        Image im = new Image(TextureCache.createGradient(0x00000000, 0x00000000, 0x00000000, 0x00000000, 0x00000000, 0xFF000000)) {
            ...
            public void update() {
                super.update();
                if (lastRegion == 6 && !Dungeon.isChallenged(Challenges.EOH))
                    aa = 1;
