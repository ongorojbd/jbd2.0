...
public class ThunderBolt extends Group {
    ...
    public static class Arc extends Group {
        ...
        public Arc(PointF from, PointF to){
            ...
            arc1 = new Image(Effects.get(Effects.Type.THUNDERBOLT));
            arc1.x = start.x - arc1.origin.x;
            arc1.y = start.y - arc1.origin.y;
            arc1.origin.set( 0, arc1.height()/2 );
            add( arc1 );

            arc2 = new Image(Effects.get(Effects.Type.THUNDERBOLT));
        ...
        @Override
        public void update() {
            float x2 = (start.x + end.x) / 2 + Random.Float( -0.5f, +0.5f );
            float y2 = (start.y + end.y) / 2 + Random.Float( -0.5f, +0.5f );
