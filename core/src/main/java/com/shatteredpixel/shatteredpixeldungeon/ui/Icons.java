	...
	public static Image get( Icons type ) {
		...
		switch (type) {
			...
			case GOLD:
				...
				break;
			case RANKINGS:
				icon.frame( icon.texture.uvRectBySize( 34, 0, 16, 16 ) );
				break;
			case BADGES:
			...
			case CHALLENGE_GREY:
				...
				break;
			case SCROLL_GREY:
				icon.frame( icon.texture.uvRectBySize( 160, 16, 16, 16 ) );
				break;
			case SEED:
			...
			case CHALLENGE_COLOR:
				...
				break;
			case SCROLL_COLOR:
				icon.frame( icon.texture.uvRectBySize( 160, 32, 16, 16 ) );
				break;
			case COPY:
			...
			case MAGNIFY:
				...
				break;
			case SNAKE:
				icon.frame( icon.texture.uvRectBySize( 48, 48,  14, 13 ) );
				break;
			case BUFFS:
