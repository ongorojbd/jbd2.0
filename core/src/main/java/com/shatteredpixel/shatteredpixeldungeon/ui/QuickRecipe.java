	...
	public static ArrayList<QuickRecipe> getRecipes( int pageIdx ){
		...
		switch (pageIdx){
			...
			case 5:
				...
				result.add(null);
                result.add(new QuickRecipe(new Shr.Recipe()));
				return result;
			case 6:
				...
				result.add(new QuickRecipe(new KSG.Recipe()));
				...
				result.add(new QuickRecipe(new Araki.Recipe()));
				result.add(null);
				result.add(null);
				result.add(new QuickRecipe(new Diodiary.Recipe()));
