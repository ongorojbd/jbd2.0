...
public class Sbr4 extends Spell {
    ...
    protected void onCast(Hero hero) {
        ...
        if (Dungeon.isChallenged(Challenges.EOH) && (Challenges.activeChallenges() >= 2))     {

            Sample.INSTANCE.play(Assets.Sounds.CHARMS);
            GameScene.flash(0xFFCC00);

            GLog.n(Messages.get(Civil.class, "sbr4"));
            ...
            Dungeon.level.drop( new ThrowingSpear().quantity(5), Dungeon.hero.pos ).sprite.drop();

            detach(Dungeon.hero.belongings.backpack);
            Statistics.thrownAttacks = 0;
            updateQuickslot();
        ...
        {
            Statistics.thrownAttacks = 0;
            GLog.h(Messages.get(Civil.class, "nomap"));
    ...
    public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe{
        ...
        {
            inputs =  new Class[]{ScrollOfPrismaticImage.class};
