...
public class Evolution extends InventorySpell {
    ...
    public static Item changeItem( Item item ){
        if (item instanceof MeleeWeapon) {
            ...
            if (((Armor) item).tier >= 5) return null;
    ...
    private static Weapon changeWeapon( Weapon w ) {
        ...
        // Evolution is now guaranteed to succeed: always target next tier (capped).
        Weapon n;
    ...
    private static Armor changeArmor( Armor a ) {
        ...
        // Evolution is guaranteed: armor always upgrades to the next tier.
        Class<?> targetClass = Generator.Category.ARMOR.classes[Math.min(4, a.tier)];
        Armor n = (Armor) Reflection.newInstance(targetClass);
        if (Challenges.isItemBlocked(n) || n.getClass() == a.getClass()) return null;
        ...
        n.cursed = a.cursed;
        n.augment = a.augment;
        n.glyphHardened = a.glyphHardened;
