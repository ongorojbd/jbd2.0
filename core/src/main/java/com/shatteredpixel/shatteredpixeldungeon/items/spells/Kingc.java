...
public class Kingc extends Spell {

    {
        image = ItemSpriteSheet.KINGC;
    }

    @Override
    protected void onCast(Hero hero) {
        Buff.affect(hero, ReachIncrease.class, ReachIncrease.DURATION);
    ...
    public int value() {
        ...
        if(Dungeon.level instanceof TendencyLevel) return 20;
