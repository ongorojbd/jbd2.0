...
public class Diomap3 extends Item {
    ...
    protected static CellSelector.Listener thrower = new CellSelector.Listener() {
        ...
        public String prompt() {
            return Messages.get(SpeedWagon3.class, "prompt");
        }
    };

    private static SpeedWagon3 getwagon(){
        for (Char ch : Actor.chars()){
            if (ch instanceof SpeedWagon3){
                return (SpeedWagon3) ch;
            }
        }
        return null;
    }
