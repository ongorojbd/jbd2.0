...
public class HeavyMachinegun extends MeleeWeapon {
    ...
    public void reload() {
        ...
        curUser.busy();
        Sample.INSTANCE.play(Assets.Sounds.RELOAD, 1.1f);
    ...
    public class Bullet extends MissileWeapon {
        ...
        public int damageRoll(Char owner) {
            ...
            if (owner.buff(Momentum.class) != null && owner.buff(Momentum.class).freerunning()) {
                bulletdamage = Math.round(bulletdamage);
            }
        ...
        public boolean hasEnchant(Class<? extends Enchantment> type, Char owner) {
            return HeavyMachinegun.this.hasEnchant(type, owner);
        }
        ...
        public int proc(Char attacker, Char defender, int damage) {
            ...
            if (HeavyMachinegun.this.enchantment == null
        ...
        @Override
        public int STRReq(int lvl) {
            return HeavyMachinegun.this.STRReq();
        }
