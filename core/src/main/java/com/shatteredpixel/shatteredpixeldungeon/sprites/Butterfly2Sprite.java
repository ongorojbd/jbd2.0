...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.KarsCorrosiveButterfly;
...
public class Butterfly2Sprite extends MobSprite {

    private int cellToAttack;

    public Butterfly2Sprite() {
        super();
    ...
    public void zap( int cell ) {
        ...
        MagicMissile.boltFromChar( parent,
                ...
                new Callback() {
                    @Override
                    public void call() {
                        ((KarsCorrosiveButterfly)ch).onZapComplete();
                    }
                } );
