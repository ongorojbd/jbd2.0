...
public class ItemSpriteSheet {
    ...
    public static final int SMOOTH = ARTIFACTS + 24;
    ...
    public static final int ROPE = QUEST + 9;
    public static final int BB = QUEST + 10;
    public static final int TBOMB = QUEST + 11;
