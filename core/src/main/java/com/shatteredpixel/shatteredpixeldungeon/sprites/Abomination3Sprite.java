...
public class Abomination3Sprite extends MobSprite {

    private int cellToAttack;

    public Abomination3Sprite() {
        super();
    ...
    public void onComplete( Animation anim ) {
        if (anim == zap) {
            ...
            MagicMissile.boltFromChar(parent, MagicMissile.SHADOW, this, cellToAttack, new Callback() {
                @Override
                public void call() {
                    ch.onAttackComplete();
                }
