...
public abstract class Sentry1Sprite extends MobSprite {
	...
	public Sentry1Sprite(){
		texture( Assets.Sprites.VAULT_LASER );
	...
	public static class Red extends Sentry1Sprite {
		@Override
	...
	public static class VaultScan extends Sentry1Sprite {
		@Override
		protected int texOffset() {
			return 1;
		}
	...
	public static class VaultLaser extends Sentry1Sprite {
		@Override
		protected int texOffset() {
			return 2;
		}
