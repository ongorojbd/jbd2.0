...
public abstract class Sentry2Sprite extends MobSprite {
	...
	public Sentry2Sprite(){
		texture( Assets.Sprites.VAULT_SENTRY );
	...
	public static class Red extends Sentry2Sprite {
		@Override
	...
	public static class VaultScan extends Sentry2Sprite {
		@Override
		protected int texOffset() {
			return 1;
		}
	...
	public static class VaultLaser extends Sentry2Sprite {
		@Override
		protected int texOffset() {
			return 2;
		}
