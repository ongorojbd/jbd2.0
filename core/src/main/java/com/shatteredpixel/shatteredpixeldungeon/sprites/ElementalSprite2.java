...
public abstract class ElementalSprite2 extends MobSprite {
    ...
    public static class Fire extends ElementalSprite2 {
    ...
    public static class NewbornFire extends ElementalSprite2 {
    ...
    public static class Frost extends ElementalSprite2 {
    ...
    public static class Shock extends ElementalSprite2 {
    ...
    public static class Chaos extends ElementalSprite2 {
