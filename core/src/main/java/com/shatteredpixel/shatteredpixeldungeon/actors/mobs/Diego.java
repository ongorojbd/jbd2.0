...
public class Diego extends Mob {
        ...
        public boolean act( boolean enemyInFOV, boolean justAlerted ) {
            ...
            if (leapPos != -1){
                ...
                sprite.jump(pos, leapPos, new Callback() {
                    ...
                    public void call() {
                        ...
                        if (endPos != leapPos){
                            Actor.addDelayed(new Pushing(Diego.this, leapPos, endPos), -1);
                        }

                        pos = endPos;
                        leapPos = -1;
                        sprite.idle();
                        Dungeon.level.occupyCell(Diego.this);
                        next();
                    }
                });
                return false;
            ...
            if (enemyInFOV && !isCharmedBy( enemy ) && canAttack( enemy )) {
                ...
                if (enemyInFOV) {
                    ...
                    state = WANDERING;
                    target = Dungeon.level.randomDestination( Diego.this );
                    return true;
                }
