...
public class Rohan3 extends NPC {
    ...
    public static void spawn(CityLevel level) {
        if (Random.Int( 2 ) == 0) {
            if (Dungeon.depth == 16 && !Dungeon.bossLevel()) {

                Rohan3 npc = new Rohan3();
                do {
