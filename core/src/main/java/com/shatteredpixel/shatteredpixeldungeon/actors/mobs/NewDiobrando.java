...
public class NewDiobrando extends Mob {

    {
        ...
        HUNTING = new NewDiobrando.Hunting();
            ...
            switch(hero.heroClass){
                case JOHNNY:
                    WndDialogueWithPic.dialogue(
                            ...
                            new String[]{"디오 브란도"},
                            new String[]{
                                    Messages.get(Diobrando.class, "17"),
                            },
                            new byte[]{
                ...
                case CLERIC:
                    WndDialogueWithPic.dialogue(
                            ...
                            new String[]{"디오 브란도"},
                            new String[]{
                                    Messages.get(Diobrando.class, "16"),
                            },
                            new byte[]{
                                    WndDialogueWithPic.IDLE
                            }
                ...
                case WARRIOR:
                    WndDialogueWithPic.dialogue(
                            ...
                            new String[]{
                                    Messages.get(Diobrando.class, "1"),
                                    Messages.get(Diobrando.class, "10")
                            },
                            new byte[]{
                                    WndDialogueWithPic.IDLE,
                                    WndDialogueWithPic.IDLE
                ...
                case MAGE:
                    WndDialogueWithPic.dialogue(
                            ...
                            new String[]{"디오 브란도"},
                            new String[]{
                                    Messages.get(Diobrando.class, "12"),
                            },
                            new byte[]{
                                    WndDialogueWithPic.IDLE
                            }
                ...
                case ROGUE:
                    WndDialogueWithPic.dialogue(
                            ...
                            new String[]{"디오 브란도"},
                            new String[]{
                                    Messages.get(Diobrando.class, "13")
                            },
                            new byte[]{
                                    WndDialogueWithPic.IDLE
                            }
                ...
                case DUELIST:
                    WndDialogueWithPic.dialogue(
                            ...
                            new String[]{
                                    Messages.get(Diobrando.class, "14"),
                ...
                case HUNTRESS:
                    WndDialogueWithPic.dialogue(
                            ...
                            new String[]{"디오 브란도"},
                            new String[]{
                                    Messages.get(Diobrando.class, "15")
                            },
                            new byte[]{
                                    WndDialogueWithPic.IDLE
                            }
    ...
    public void damage(int dmg, Object src) {
        ...
        if (Phase==0 && HP < 500) {
            ...
            summonRats(2);
            yell(Messages.get(Diobrando.class, "t"));
            zcooldown = 26;
        }
        ...
        if (Phase==1 && HP < 155) {
            ...
            GLog.n(Messages.get(Diobrando.class, "j"));
    ...
    private boolean UseAbility() {
        ...
        if (zcooldown <= 0) {
            yell( Messages.get(Diobrando.class, "zomb") );
            CellEmitter.get( this.pos ).burst( MagicMissile.MagicParticle.FACTORY, 12 );
            Sample.INSTANCE.play(Assets.Sounds.DIO6);
    ...
    public int attackProc(Char enemy, int damage) {
        ...
        if (this.buff(IceBlow.class) != null) {
            ...
            yell( Messages.get(Diobrando.class, "armad") );
            Buff.detach(this, IceBlow.class);

            if (enemy == Dungeon.hero && !enemy.isAlive()) {
                Dungeon.fail(getClass());
                GLog.n(Messages.get(Diobrando.class, "d"));
            }
        }
    ...
    public int defenseProc( Char enemy, int damage ) {
        ...
        if (this.buff(IceBlow.class) != null) {
            ...
            if(enemy == hero) {
                ...
                // 강화된 IceBlow 반격 데미지
                enemy.damage(Random.NormalIntRange(30, 40), this);
            }
            GameScene.flash(0x33CCFF);
            Sample.INSTANCE.play(Assets.Sounds.DIO3);
            new ChillingTrap().set(enemy.pos).activate();
    ...
    protected boolean act() {
        ...
        if (barriercooldown == 1)  {
            ...
            GLog.w(Messages.get(Diobrando.class, "i"));
        ...
        public boolean act( boolean enemyInFOV, boolean justAlerted ) {
                ...
                sprite.jump(pos, leapPos, new Callback() {
                    ...
                    public void call() {
                        ...
                        if (leapVictim != null && alignment != leapVictim.alignment){
                            // 강화된 Leap 공격의 Bleeding 데미지
                            Buff.affect(leapVictim, Bleeding.class).set(1.5f * damageRoll());
                            leapVictim.sprite.flash();
                            Sample.INSTANCE.play(Assets.Sounds.HIT);
                        }

                        if (endPos != leapPos){
                            Actor.addDelayed(new Pushing(NewDiobrando.this, leapPos, endPos), -1);
                        }

                        pos = endPos;
                        leapPos = -1;
                        sprite.idle();
                        Dungeon.level.occupyCell(NewDiobrando.this);
                        next();
                    }
                });
                return false;
            ...
            if (enemyInFOV && !isCharmedBy( enemy ) && canAttack( enemy )) {
                ...
                if (enemyInFOV) {
                    ...
                    state = WANDERING;
                    target = Dungeon.level.randomDestination( NewDiobrando.this );
                    return true;
                }
    ...
    public void die( Object cause ) {
        ...
        InterlevelScene.returnDepth = 27;
        ...
        //delay fire on a rooted hero
            ...
            for (Char ch : affected) {
                if(ch instanceof SpeedWagon) {
                    ...
                    // 강화된 FireBlast 데미지
                    ch.damage(Random.NormalIntRange(30, 50), new NewDiobrando.Blast());
                }
                if (Dungeon.level.heroFOV[pos]) {
                    ch.sprite.flash();
