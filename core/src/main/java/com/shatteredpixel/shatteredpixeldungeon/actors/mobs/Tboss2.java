...
public class Tboss2 extends Mob {
        ...
        public boolean act( boolean enemyInFOV, boolean justAlerted ) {
            ...
            if (leapPos != -1){
                ...
                sprite.jump(pos, leapPos, new Callback() {
                    ...
                    public void call() {
                        ...
                        if (endPos != leapPos){
                            Actor.addDelayed(new Pushing(Tboss2.this, leapPos, endPos), -1);
                        }

                        pos = endPos;
                        leapPos = -1;
                        sprite.idle();
                        Dungeon.level.occupyCell(Tboss2.this);
                        next();
                    }
                });
                return false;
            ...
            if (enemyInFOV && !isCharmedBy( enemy ) && canAttack( enemy )) {
                ...
                if (enemyInFOV) {
                    ...
                    state = WANDERING;
                    target = Dungeon.level.randomDestination( Tboss2.this );
                    return true;
                }
    ...
    private boolean FireBlast() {
        ...
        for (Char ch : affected) {
            if(ch instanceof SpeedWagon) {
                ...
                ch.damage(Random.NormalIntRange(20, 25), new Tboss2.Blast());
            }
            if (Dungeon.level.heroFOV[pos]) {
                ch.sprite.flash();
