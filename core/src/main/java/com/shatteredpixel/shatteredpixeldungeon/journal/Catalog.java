...
import com.shatteredpixel.shatteredpixeldungeon.items.remains.Danny3;
...
public enum Catalog {
	...
	static {
		...
		ARTIFACTS.addItems(LloydsBeacon.class, Madeinheaven.class, WoundsofWar.class, CapeOfThorns.class);

		TRINKETS.addItems(Generator.Category.TRINKET.classes);

		COMICBOOK.addItems(Jojo1.class, Jojo2.class, Jojo3.class, Jojo4.class,
		...
		BOMBS.addItems( Bomb.class, FrostBomb.class, Firebomb.class, SmokeBomb.class, RegrowthBomb.class,
				WoollyBomb.class, Noisemaker.class, FlashBangBomb.class, HolyBomb.class, ArcaneBomb.class, ShrapnelBomb.class, Shr.class, ThirdBomb.class);
		...
		MISC_CONSUMABLES.addItems( Gold.class, EnergyCrystal.class, Dewdrop.class,
				...
				SealShard.class, BrokenStaff.class, CloakScrap.class, BrokenHilt.class, BowFragment.class, TornPage.class, Danny3.class, Ram2.class, UV.class, Drago.class, Highway.class, FormaggioBottle.class, Araki.class);
	...
	static {
		...
		equipmentCatalogs.add(COMICBOOK);
		equipmentCatalogs.add(MISC_EQUIPMENT);
		equipmentCatalogs.add(SPECIAL_WEAPONS);
	}
	...
	static {
		...
		consumableCatalogs.add(JOJOLION);
