...
public class SPDSettings extends GameSettings {
	...
	public static final String SKIN7 = "skin7";
	...
	public static void addSkin7(int value) { put(SKIN7, getInt(SKIN7, 0) + value); }
	...
	public static int getSkin7() { return getInt(SKIN7, 0); }
