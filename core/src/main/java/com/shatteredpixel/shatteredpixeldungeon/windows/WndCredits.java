...
public class WndCredits extends Window {
	...
	public WndCredits() {
		...
		CreditsBlock kristjan = new CreditsBlock(false, Window.SHPX_COLOR,
				...
				"",
				"");
		kristjan.setRect(OFFSET, pos, (WIDTH - 20) / 2f, 0);
		content.add(kristjan);
		pos = kristjan.bottom() + 8;
	...
	private void addLine(float y, Group content, int offset) {
