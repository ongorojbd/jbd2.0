...
public class WndTendency2 extends Window {
    ...
    public WndTendency2( Blacksmith troll, Hero hero ) {
        super();
        ...
        RedButton pickaxe = new RedButton(Messages.get(this, "pickaxe", pickaxeCost), 6){
            ...
            protected void onClick() {
                GameScene.show(new WndOptions(
                        ...
                        Messages.get(WndTendency2.class, "pickaxe_verify") + (pickaxeCost == 0 ? "\n\n" + Messages.get(WndTendency2.class, "pickaxe_free") : ""),
                        Messages.get(WndTendency2.class, "pickaxe_yes"),
                        Messages.get(WndTendency2.class, "pickaxe_no")
                ){
                    @Override
        ...
        RedButton reforge = new RedButton(Messages.get(this, "reforge", reforgecost), 6){
            @Override
            protected void onClick() {
                GameScene.show(new WndReforge(troll, WndTendency2.this));
            }
        };
        ...
        RedButton smith = new RedButton(Messages.get(this, "smith", 2000), 6){
            ...
            protected void onClick() {
                GameScene.show(new WndOptions(
                        troll.sprite(),
                        Messages.titleCase( troll.name() ),
                        Messages.get(WndTendency2.class, "smith_verify"),
                        Messages.get(WndTendency2.class, "smith_yes"),
                        Messages.get(WndTendency2.class, "smith_no")
                ){
                    @Override
                    protected void onSelect(int index) {
                        if (index == 0){
        ...
        RedButton cashOut = new RedButton(Messages.get(this, "cashout"), 6){
            ...
            protected void onClick() {
                GameScene.show(new WndOptions(
                        troll.sprite(),
                        Messages.titleCase( troll.name() ),
                        Messages.get(WndTendency2.class, "cashout_verify", Blacksmith.Quest.favor),
                        Messages.get(WndTendency2.class, "cashout_yes"),
                        Messages.get(WndTendency2.class, "cashout_no")
                ){
                    @Override
                    protected void onSelect(int index) {
                        if (index == 0){
