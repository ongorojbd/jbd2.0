...
public class DoobieTrap extends Trap {
                ...
                Actor.add(new Actor() {
                    ...
                    protected boolean act() {
                        ...
                        ((MissileSprite) ShatteredPixelDungeon.scene().recycle(MissileSprite.class)).
                                reset(pos, finalTarget.sprite, new RoundShield(), new Callback() {
                                    @Override
                                    public void call() {
                                        ...
                                        Buff.affect( finalTarget, MoveDetect.class, 10f );
