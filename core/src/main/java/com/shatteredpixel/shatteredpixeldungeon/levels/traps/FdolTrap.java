...
import com.shatteredpixel.shatteredpixeldungeon.actors.mobs.Fdol;
...
public class FdolTrap extends Trap {


    private static final float DELAY = 0f;

    private static final ArrayList<Class<?extends Mob>> RARE = new ArrayList<>(Arrays.asList(
            Fdol.class, Fdol.class));
