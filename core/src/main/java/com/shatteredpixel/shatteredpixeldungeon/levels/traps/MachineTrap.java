...
public class MachineTrap extends Trap {
                ...
                Actor.add(new Actor() {
                    ...
                    protected boolean act() {
                        ...
                        ((MissileSprite) ShatteredPixelDungeon.scene().recycle(MissileSprite.class)).
                                reset(pos, finalTarget.sprite, new HealingDart(), new Callback() {
                                    @Override
                                    public void call() {
                                        ...
                                        Buff.affect( finalTarget, Vitam.class, 10f );
